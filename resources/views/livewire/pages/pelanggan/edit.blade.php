...
mount(function (Pelanggan $pelanggan) {
    ...
    $this->status = (bool) ($pelanggan->status ?? false);
});
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center space-x-4 mb-8">
                <div class="p-3 bg-white rounded-lg shadow-sm">
                    <flux:icon name="user" class="h-8 w-8 text-indigo-600" />
                </div>
                <div>
            ...
            <div class="bg-white/90 backdrop-blur-xl border border-gray-200 shadow-xl rounded-2xl p-8">
                <form wire:submit="update">
                    ...
                    <div class="flex items-center justify-end mt-10 gap-3">
                        ...
                        <x-button type="submit" class="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold shadow-md transition-all duration-150">
                            {{ __('Perbarui') }}
                        </x-button>
                    </div>
                </form>
