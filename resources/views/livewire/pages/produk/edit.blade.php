        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Produk</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        Perbarui informasi produk perhiasan.
                    </p>
                </div>
            </div>
                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    @if($produk->foto)
                                        <div class="mr-4">
                                            <img src="{{ Storage::url($produk->foto) }}" class="h-20 w-20 object-cover rounded-md">
                                        </div>
                                    @endif
                                ...
                                @error('newFoto') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                @if ($newFoto)
                                    <div class="mt-2">
                                        <img src="{{ $newFoto->temporaryUrl() }}" class="h-20 w-20 object-cover rounded-md">
                                    </div>
                                @endif
                            </div>
