...
<div class="max-w-3xl mx-auto px-4 py-12">
    <h1 class="text-xl md:text-2xl font-bold text-slate-700 mb-4 flex items-center gap-2"><i
            class="fa-solid fa-file-invoice-dollar text-indigo-500"></i> Detail Transaksi</h1>
