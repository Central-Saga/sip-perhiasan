<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Total Pelanggan -->
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-indigo-700 dark:text-indigo-200">{{ \App\Models\Pelanggan::count() }}</p>
                </div>
            </div>
            <!-- Total Produk -->
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-700 dark:text-purple-200">{{ \App\Models\Produk::count() }}</p>
                </div>
            </div>
            <!-- Total Transaksi -->
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-700 dark:text-green-200">{{ \App\Models\Transaksi::count() }}</p>
                </div>
            </div>
            <!-- Total Custom Request -->
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 flex items-center gap-4">
                <div class="p-3 bg-blue-50 dark:bg-blue-900 rounded-lg">
                    <flux:icon name="document-text" class="h-8 w-8 text-blue-600 dark:text-blue-300" />
                </div>
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-300">Total Custom Request</p>
                    <p class="text-2xl font-bold text-blue-700 dark:text-blue-200">{{ \App\Models\CustomRequest::count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700">
