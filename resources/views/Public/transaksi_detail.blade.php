...
<h1 class="text-xl md:text-2xl font-bold text-slate-700 mb-4 flex items-center gap-2"><i class="fa-solid fa-file-invoice-dollar text-indigo-500"></i> Detail Transaksi</h1>
    <div class="bg-white rounded-xl shadow p-6 mb-8">
        ...
        <div class="mt-6 flex gap-4">
            <a href="{{ route('cart') }}" class="px-4 py-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium flex items-center gap-2"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
</div>
@endsection
